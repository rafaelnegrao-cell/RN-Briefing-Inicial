...
function renderList(subs) {
  ...
  if (!subs.length) {
    root.appendChild(el(`<div class="note-card green"><h4>Nenhuma resposta ainda</h4><p>Quando a Dra. Francielle enviar o briefing, ele aparece aqui automaticamente.</p></div>`));
    return;
  }
